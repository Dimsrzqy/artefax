                ...
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body d-flex align-items-center">
                        <div class="input-group w-75 mx-auto d-flex">
                            ...
                            <span id="search-icon-1" class="input-group-text p-3" onclick="searchProducts()">
                                <i class="fa fa-search"></i>
                            </span>
                        </div>
                        <div id="searchResults" class="w-100 position-absolute bg-white rounded shadow-sm" 
                             style="top: 100%; display: none; max-height: 300px; overflow-y: auto;">
                        </div>
                    </div>
                </div>
            </div>
