...
$cartItems = [];
$subtotal = 0;
$totalItems = 0; // Tambahkan variabel untuk total item
if (!empty($_SESSION['cart'])) {
    ...
    foreach ($products as $product) {
        ...
        $totalItems += $qty; // Hitung total item
    }
}
            ...
            <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                ...
                <div class="d-flex m-3 me-0">
                    ...
                    <a href="#" class="position-relative me-4 my-auto">
                        ...
                        <?php if ($totalItems > 0): ?>
                        <span class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style="top: -5px; left: 15px; height: 20px; min-width: 20px;"><?php echo $totalItems; ?></span>
                        <?php endif; ?>
                    </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                            <form method="post" class="d-flex" id="form-<?= $item['id'] ?>">
                                                <input type="hidden" name="product_id" value="<?= $item['id'] ?>">
                                                <input type="hidden" name="action" value="update">
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-sm btn-minus rounded-circle bg-light border" data-product-id="<?= $item['id'] ?>">
                                                ...
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-sm btn-plus rounded-circle bg-light border" data-product-id="<?= $item['id'] ?>">
                ...
                <div class="row g-4 justify-content-end">
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <a href="checkout.php" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4">
                                Proceed Checkout
                            </a>
                        </div>
                    </div>
