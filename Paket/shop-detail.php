...
try {
    ...
    $stmt = $pdo->query("SELECT * FROM products WHERE category = 'Bestseller' LIMIT 6");
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="mb-3">Category: <?= htmlspecialchars($product['category']); ?></p>
                    ...
                    <div class="col-lg-4 col-xl-3">
                        <div class="row g-4 fruite">
                                        ...
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="shop.php?category=<?= urlencode($cat['category']); ?>">
                                                    <i class="fas fa-apple-alt me-2"></i><?= htmlspecialchars($cat['category']); ?>
                                                </a>
                                                <span>(<?= $cat['count']; ?>)</span>
                                            </div>
                                        </li>
                            ...
                            <div class="col-lg-12">
                                ...
                                <?php foreach($featuredProducts as $feat): ?>
                                <div class="d-flex align-items-center justify-content-start mb-4">
                                    <div class="rounded" style="width: 100px; height: 100px;">
                                        <img src="<?= htmlspecialchars($feat['image']); ?>" class="img-fluid rounded" alt="">
                                    </div>
                                    <div class="ms-4">
                                        <h6 class="mb-2"><?= htmlspecialchars($feat['name']); ?></h6>
                                        ...
                                        <div class="d-flex mb-2">
                                            <h5 class="fw-bold me-2">$<?= number_format($feat['price'], 2); ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                    ...
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        ...
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="<?= htmlspecialchars($related['image']); ?>" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            ...
                            <div class="p-4 pb-0 rounded-bottom">
                                ...
                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    <p class="text-dark fs-5 fw-bold">$<?= number_format($related['price'], 2); ?> / kg</p>
                                    <a href="shop-detail.php?id=<?= $related['id']; ?>" class="btn border border-secondary rounded-pill px-3 py-1 mb-4 text-primary">
