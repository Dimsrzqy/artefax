      ...
      <div class="container">
        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="../form-karyawan/form-karyawan.php" class="nav-link">Karyawan</a></li>
            <li class="nav-item active"><a href="absensi-karyawan.php" class="nav-link">Absensi</a></li>
          </ul>
        </div>
