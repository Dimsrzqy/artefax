...
<head>
    ...
    <style>
        ...
        .badge-Karyawan { background-color: #ffc107; color: #212529; }
        ...
        <div class="container">
            ...
            <div class="az-header-menu">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item active"><a href="form-user.php" class="nav-link"><i class="typcn typcn-group"></i> User</a></li>
                    <li class="nav-item"><a href="../form-layanan/form-layanan.php" class="nav-link"><i class="typcn typcn-puzzle-outline"></i> Layanan</a></li>
                    <li class="nav-item"><a href="../form-laporan/LaporanAbsensiKaryawan.php" class="nav-link"><i class="typcn typcn-group-outline"></i> Laporan</a></li>
                </ul>
            </div>
    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
        <div class="container">
            ...
            <div class="az-content-body pd-lg-l-40 d-flex flex-column">
                ...
                <h4 class="tx-20 tx-bold mg-b-20">Daftar User</h4>
