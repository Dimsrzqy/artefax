    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
        <div class="container">
            ...
            <div class="az-content-body pd-lg-l-40 d-flex flex-column">
                ...
                <h2 class="az-content-title"><i class="fas fa-clock"></i> Daftar Absensi Karyawan</h2>
                ...
                <div class="col-lg-12 mg-t-20" style="max-width: 100%; margin-top: 5px !important;">
                    ...
                    if (!$conn) {
                        ...
                        $binding_params[] = $limit;
                        $binding_params[] = $offset;
                        $binding_types = $types . 'ii';
                        if ($binding_types) {
                            $ref_params = [];
                            foreach ($binding_params as $key => $value) {
                                $ref_params[$key] = &$binding_params[$key];
                            }
                            $stmt->bind_param($binding_types, ...$ref_params);
                        }
                        $stmt->execute();
                        ...
                        if ($result->num_rows === 0 && $totalRows == 0) {
                            ...
                            if ($totalPages > 1) {
                                ...
                                echo "<div class='text-center mt-2' style='color: #6c757d; font-size: 14px;'>";
                                echo "Menampilkan $showing_from - $showing_to dari $totalRows data";
                                echo "</div>";
                            }
                            // --- END: PERBAIKAN PAGINATION ---
                        }
                        $stmt->close();
                    }
                    ?>
