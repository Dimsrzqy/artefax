                  ...
                  <tr>
                    ...
                    <td>
                      <div class="tombol-aksi">
                        <button class="btn btn-sm btn-info btn-aksi-uniform" 
                                onclick='openDetailPopup(<?= json_encode($pf, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>)'>
                          <i class="fas fa-eye"></i> Detail
                        </button>

                        <!-- TOMBOL HAPUS DIPERBAIKI: PAKAI LINK + CONFIRM -->
                        <a href="hapus_pembayaran.php?id=<?= $p['IDPembayaran'] ?>&page=<?= $page ?>"
                           class="btn btn-sm btn-danger btn-aksi-uniform"
